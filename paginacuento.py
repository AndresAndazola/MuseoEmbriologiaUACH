...
<head>
    ...
    <style>
        ...
        body {
    background-color: #3f51b5; /* rojo peligro/danger (Bootstrap) */
    font-size: 16px;
    margin: 0;
}
...
<div class="container">
    ...
    <img src="imagenes/Juanito.png" alt="Juanito" class="animate" onclick="onClick(this)">
    ...
    <img src="imagenes/Sofia.png" alt="Sofia" class="animate" onclick="onClick(this)">
    ...
    <img src="ovulo.png" alt="Recorrido" class="animate" onclick="onClick(this)">
    <img src="encuentro.png" alt="Recorrido" class="animate" onclick="onClick(this)">
    ...
    <img src="blastocisto.png" alt="blastocisto" class="animate" onclick="onClick(this)">
    ...
    <img src="azulo.png" alt="no se" class="animate" onclick="onClick(this)">

...
<nav class="w3-sidebar w3-indigo w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
  ...
  <div class="w3-container" style="text-align: right;">
    <h3 class="w3-padding-64" style="color: white; margin: 0; text-align: left;"><b>Museo<br>de Embriología</b></h3>
  </div>
  <div class="w3-bar-block">
    <a href="#espermatogenesis" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white" style="font-size: 17px; text-align: left; padding-left: 16px;">Espermatogénesis</a>
    <a href="#ovogenesis" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white" style="font-size: 17px; text-align: left; padding-left: 16px;">Ovogénesis</a>
    <a href="#fertilizacion" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white" style="font-size: 17px; text-align: left; padding-left: 16px;">Fertilización</a>
    <a href="#transporte-ovocito" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white" style="font-size: 17px; text-align: left; padding-left: 16px;">Transporte del ovocito</a>
    <a href="#transporte-espermatozoides" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white" style="font-size: 17px; text-align: left; padding-left: 16px;">Transporte de espermatozoides</a>
    <a href="#detalle-fertilizacion" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white" style="font-size: 17px; text-align: left; padding-left: 16px;">Llegada a la fertilización</a>
    <a href="index.html" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white"
       style="font-size: 17px; text-align: left; padding-left: 16px; margin-top: 50px;">Volver al inicio</a> 
  </div>
</nav>

<!-- Menu para pantallas pequeñas (celulares) -->
<header class="w3-container w3-top w3-hide-large w3-indigo w3-xlarge w3-padding" style="display: flex; align-items: center;">
  <a href="javascript:void(0)" onclick="w3_open()" 
     class="w3-button" 
     style="background-color: #4b0082; color: white; padding: 8px 16px; border-radius: 4px; margin-right: 16px;">☰</a>
  <span style="color: white; font-size: 20px; text-align: left;">Museo de Embriología</span>
</header>

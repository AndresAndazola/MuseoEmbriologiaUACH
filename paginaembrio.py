...
<div class="w3-container" style="margin-top:80px" id="contenido">
  <h1 class="w3-jumbo w3-text-indigo" style="display: flex; align-items: center; gap: 15px;">
  <img src="imagenes/isotipo.png" alt="isotipo" style="height: 175px;">
    <span style="line-height: 1.2; font-size: 55px;">
      <b>Museo de Embriología</b><br>
  <b>“Dra. Dora Virginia Chávez Corral”</b>
    </span>
...
<div class="w3-row-padding">
  ...
  <!-- Informacion -->
      ...
      <div class="w3-row-padding">
         <div class="w3-half w3-margin-bottom w3-center" style="float: none; margin: 50px auto 0;">
           <ul class="w3-ul w3-light-grey w3-center">
             <li class="w3-indigo w3-xlarge w3-padding-32">Agenda tu cita.</li>
             <li class="w3-light-grey w3-padding-24">
               <!-- Cambiar Sign Up a un enlace -->
               <a href="https://embryopass.onrender.com" class="w3-button w3-indigo w3-padding-large w3-hover-black">Entrar</a>
             </li>
           </ul>
         </div>

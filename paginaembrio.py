   ...
   <div class="w3-half w3-margin-bottom">
     <ul class="w3-ul w3-light-grey w3-center">
       ...
       <li class="w3-light-grey w3-padding-24">
         ...
         <a href="index_cuento.html" class="w3-button w3-white w3-padding-large w3-hover-black">Entrar</a>
       </li>
     </ul>
   </div>
   ...
   <div class="w3-half">
     <ul class="w3-ul w3-light-grey w3-center">
       ...
       <li class="w3-light-grey w3-padding-24">
         ...
         <a href="index_estudiantes.html" class="w3-button w3-red w3-padding-large w3-hover-black">Entrar</a>
       </li>
     </ul>
   </div>
</div>
